...
class UrlRewriter_BbCode_Formatter_Base extends XFCP_UrlRewriter_BbCode_Formatter_Base {
  ...
  protected $_replace = array(
    ...
    '<a href="[URL]">[NAME]</a><br /><ifraime src="http://www.gpsies.com/mapOnly.do?fileId=${1}" width="[WIDTH]" height="[HEIGHT]" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>', // GPSies
